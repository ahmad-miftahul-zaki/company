...
<div class="menu">
	...
	<li role="presentation" class="active"><a href="department.php">Department</a></li>
...
<div class="content">
<form method="post" action="sdepartment.php">
<div class="row">
<center>
	<table>
	<tr>
		<td width="160px">Department Name</td>
		<td width="80px">:</td>
  ...
  echo "<tr>";
	echo "<td>$data[0]</td>";
	echo "<td>$data[1]</td>";
	echo "<td><a href=edepartment.php?dnumber=$data[1]>Edit</a> | <a href=ddepartment.php?dnumber=$data[1]>Delete</a></td>";
  echo "</tr>";
  }
  ?>
