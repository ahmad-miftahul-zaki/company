...
<div class="menu">
	...
	<li role="presentation" class="active"><a href="dependent.php">Dependent</a></li>						
...
<div class="content">
<form method="post" action="sdependent.php">
<div class="row">
<center>
	<table>
	<tr>
	...
	<tr>
		<td width="160px">Dependent Name</td>
		<td width="80px">:</td>
	...
	<tr>
		<td width="160px">Relationship</td>
		<td width="80px">:</td>
  ...
  <tr>
	...
	<th width="200px">Dependent Name</th>
  ...
  echo "<tr>";
	...
	echo "<td>$data[3]</td>";
	echo "<td>$data[4]</td>";
	echo "<td><a href=edependent.php?essn=$data[0]>Edit</a> | <a href=ddependent.php?essn=$data[0]>Delete</a></td>";
  echo "</tr>";
  }
  ?>
