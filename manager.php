...
<div class="menu">
	...
	<li role="presentation" class="active"><a href="manager.php">Manager</a></li>						
...
<div class="content">
<form method="post" action="smanager.php">
<div class="row">
<center>
	<table>
	<tr>
	...
	<tr>
		<td width="160px">SSN Manager</td>
		<td width="80px">:</td>
		<td><input type="text" name="mgrssn"></td>
	</tr>
	<tr>
		<td width="160px">Start Date Manager</td>
		<td width="80px">:</td>
		<td><input type="date" name="mgrstartdate"></td>
	</tr>
	<tr>
		<td width="160px"></td>
		<td width="80px"></td>
  ...
  <tr>
	...
	<th width="200px">SSN Manager</th>
	<th width="200px">Start Date Manager</th>
  ...
  echo "<tr>";
	...
	echo "<td>$data[1]</td>";
	echo "<td>$data[2]</td>";
	echo "<td><a href=emanager.php?dnumber=$data[0]>Edit</a>|<a href=dmanager.php?dnumber=$data[0]>Delete</a></td>";
  echo "</tr>";
  }
  ?>
