...
<div class="menu">
	...
	<li role="presentation" class="active"><a href="project.php">Project</a></li>
...
<div class="content">
<form method="post" action="sproject.php">
<div class="row">
<center>    
	<table>
	<tr>
	...
	<tr>
		<td width="160px">Project Location</td>
		<td width="80px">:</td>
  ...
  <tr>
	...
	<th width="100px">Project Number</th>
	<th width="100px">Department Number</th>
	<th width="100px">Project Location</th>
	<th>Action</th>
  </tr>
  <?php
  include "koneksi.php";
  ...
  echo "<tr>";
	...
	echo "<td>$data[2]</td>";
	echo "<td>$data[3]</td>";
	echo "<td><a href=eproject.php?pnumber=$data[1]>Edit</a>|<a href=dproject.php?pnumber=$data[1]>Delete</a></td>";
  echo "</tr>";
  }
  ?>
